...
type ServerInterface interface {
	...
	DeleteUserByID(ctx echo.Context, userId uint) error
	// Update user data
	// (PATCH /users/{user_id})
	PatchUserByID(ctx echo.Context, userId uint) error
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.DELETE(baseURL+"/users/:user_id", wrapper.DeleteUserByID)
	router.PATCH(baseURL+"/users/:user_id", wrapper.PatchUserByID)
...
func (sh *strictHandler) DeleteUserByID(ctx echo.Context, userId uint) error {
...
func (sh *strictHandler) PatchUserByID(ctx echo.Context, userId uint) error {
